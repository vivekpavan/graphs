...
public class Graphs {
    private  class Node {
        ...
        //we override the toString method because while printing the java will convert the node into String
        //and output the address String of the node , instead we want to output the label which is also a String
